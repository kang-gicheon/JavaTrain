...
public class Day {
	...
	{31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31},	// 평년
	...
	public Day() {
		...
		this.year = today.get(month) + 1;	// 월
		this.year = today.get(date);		// 일
...
//  일 가져오기
	...
	public boolean isLeap() {
		...
		return isLeap(year);		// 클래스에서도 메서드 버전의 isLeap 호출
